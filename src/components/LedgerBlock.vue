<template>
    <v-card v-if="(lblock.type == 'other' && lblock.text != '') || lblock.type != 'other'">
            <v-container>
                <v-row no-gutters>
                    <v-col md="1" v-if="lblock.type == 'transaction'">
                        <v-menu
                            v-model="datemenu"
                    ...
                    <v-col :md="(open || alwaysshowcomments) ? 4 : 2" cols="12" v-if="lblock.type == 'transaction'">
                    ...
                    <v-col md="6" cols="12" v-if="(open || alwaysshowcomments) && lblock.type == 'transaction'">
                    ...
                    <v-col :md="open || (lblock.type =='other' && lblock.postingIndexes.length <=0) ? 12 : 4" v-if="lblock.type == 'other'">
                        <v-textarea hide-details="auto" filled auto-grow label="Generic Ledger Block" rows="1" v-model="lblock.text"></v-textarea>
                    </v-col>
                    <v-col md="12" v-if="lblock.type == 'comment'">
                        <v-textarea hide-details="auto" filled auto-grow label="Comment Block" rows="3" v-model="lblock.text"></v-textarea>
                    </v-col>
                    <v-col v-if="(lblock.type == 'transaction' && !open && alwaysshowcomments)" md="4" cols="0">&nbsp;</v-col>
                    <v-col md="3" cols="12" v-if="!open && lblock.type != 'comment' && (lblock.postingIndexes.length > 0 || lblock.type =='transaction')">
                    ...
                    <v-col md="2" cols="12" v-if="!open && lblock.type != 'comment' && (lblock.postingIndexes.length > 0 || lblock.type =='transaction')">
                    ...
                    <v-col md="0" cols="12" v-if="open" class="md12"></v-col>
